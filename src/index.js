...
/*From line 39 to line 2941 

All of the contract’s abis and public addresses are declared, there is no need to change them unless for adding new 
exchanges to the bot. Abis are just JSON representations of the smart contracts, needed so that the web3.js can create 
raw byte strings for calling the smart contract functions. The contract is created with ABI plus the contract’s address 
and is basically a JS version of the smart contract.
